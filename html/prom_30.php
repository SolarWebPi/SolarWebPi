...
$sql = "SELECT Fecha, maxIbat, minIbat, avgIbat
		FROM diario WHERE Fecha>= SUBDATE(NOW(), INTERVAL 31 DAY)
...
<div id="container4" style="width: 48%; height: 240px; margin-left: 5; float: left"></div>
<div id="container5" style="width: 48%; height: 240px; margin-left: 5; float: right"></div>
<br style="clear:both;"/>
<br>
<div id="container7" style="width: 48%; height: 240px; margin-left: 5; float: left"></div>
<div id="container6" style="width: 48%; height: 240px; margin-left: 5; float: right"></div>
<br style="clear:both;"/>
<br>
<div id="container8" style="width: 48%; height: 240px; margin-left: 5; float: left"></div>
<div id="container9" style="width: 48%; height: 240px; margin-left: 5; float: right"></div>
<br style="clear:both;"/>
<br>
